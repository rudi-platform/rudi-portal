...
public class MismatchedChildrenValuesCount extends RuntimeException {
	...
	private static final long serialVersionUID = 5878005945764232928L;

	public MismatchedChildrenValuesCount(FieldSpec parentFieldSpec, Integer count1, Integer count2) {
		super(String.format(
				"Every children of %s must have the same amount of values in metadatafields. Found at least one difference : %s != %s.",
				parentFieldSpec.getName(), count1, count2));
	}
}
