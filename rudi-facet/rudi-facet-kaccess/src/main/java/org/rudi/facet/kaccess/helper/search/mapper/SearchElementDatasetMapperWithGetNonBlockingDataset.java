 ...
 */
@Component
public class SearchElementDatasetMapperWithGetNonBlockingDataset extends SearchElementDatasetMapper {

	private final DatasetOperationAPI datasetOperationAPI;

	public SearchElementDatasetMapperWithGetNonBlockingDataset(MetadataBlockHelper metadataBLockHelper,
	...
	protected DatasetMetadataBlock getDatasetMetadataBlock(SearchDatasetInfo searchDatasetInfo)
		...
		final Dataset dataset = datasetOperationAPI.getNonBlockingDataset(searchDatasetInfo.getGlobalId());
