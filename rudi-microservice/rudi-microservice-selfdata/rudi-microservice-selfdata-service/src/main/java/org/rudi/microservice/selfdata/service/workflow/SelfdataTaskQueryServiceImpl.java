...
@Service
public class SelfdataTaskQueryServiceImpl
		extends AbstractTaskQueryServiceImpl<SelfdataTaskSearchCriteria, HistoricSearchCriteria> {
	...
	protected void applyExtentedCriteria(TaskQuery taskQuery, SelfdataTaskSearchCriteria taskSearchCriteria) {
		if (StringUtils.isNotEmpty(taskSearchCriteria.getTitle())) {
			taskQuery.processVariableValueLikeIgnoreCase(SelfdataWorkflowConstants.TITLE,
