...
/**
 * Utilisé à la place de {@link org.springframework.security.web.server.authentication.HttpBasicServerAuthenticationEntryPoint} car ce dernier fait
 * apparaître des popin à chaque erreur 401 (cf RUDI-1626).
 *
 * <p>
 * Avec cette classe, on indique plutôt à l'utilisateur qu'il doit s'authentifier en mode "Bearer" plutôt qu'en "Basic". Dans ce cas le navigateur
 * n'affiche pas de popin.
 * </p>
 *
