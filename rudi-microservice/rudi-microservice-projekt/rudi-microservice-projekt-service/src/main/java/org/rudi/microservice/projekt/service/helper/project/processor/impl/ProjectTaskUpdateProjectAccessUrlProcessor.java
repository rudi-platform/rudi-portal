...
public class ProjectTaskUpdateProjectAccessUrlProcessor extends AbstractProjectTastUpdateProjectStringFieldProcessor {
	...
	private final List<String> ACCEPTED_SCHEMES = List.of("https","http","ftp");
	...
	private boolean validateUrl(String url){
		...
		try {
			...
			log.error(String.format("URL non valide : %s. Schemas autorisés : %s",url, StringUtils.join(ACCEPTED_SCHEMES, ", ")));
			return false;
		}
	}
}
