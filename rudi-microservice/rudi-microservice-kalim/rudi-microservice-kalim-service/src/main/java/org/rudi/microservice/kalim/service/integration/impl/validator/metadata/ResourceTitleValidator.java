...
@Component
public class ResourceTitleValidator extends AbstractMetadataValidator<String> {
	...
	public Set<IntegrationRequestErrorEntity> validate(String resourceTitle) {
		...
		if (StringUtils.isEmpty(resourceTitle)) {
			...
			IntegrationRequestErrorEntity integrationRequestError = new IntegrationRequestErrorEntity(UUID.randomUUID(),
					IntegrationError.ERR_202.getCode(), errorMessage, RudiMetadataField.RESOURCE_TITLE.getLocalName(),
					LocalDateTime.now());
