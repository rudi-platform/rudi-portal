...
import static org.rudi.microservice.kalim.service.integration.impl.validator.interfacecontract.map.parameter.MapConnectorParametersConstants.WFS_MANDATORY_PARAMS;
...
@Component
public class InterfaceContractWfsValidator implements InterfaceContractConnectorValidator {

	@Override
	public InterfaceContract getInterfaceContract() {
		return InterfaceContract.WFS;
	}
	...
	public void validate(List<String> connectorParametersKeys, Set<IntegrationRequestErrorEntity> errorEntities) {
		...
		if(!connectorParametersKeySet.containsAll(WFS_MANDATORY_PARAMS)){
