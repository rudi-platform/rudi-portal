...
@Component
public abstract class AbstractNotEmptyRichDictionaryEntryListValidator
		extends AbstractMetadataValidator<List<RichDictionaryEntry>> {

	protected abstract FieldSpec getFieldName();

	@Override
	public Set<IntegrationRequestErrorEntity> validate(List<RichDictionaryEntry> dictionaryEntries) {
		...
		for (RichDictionaryEntry entry : dictionaryEntries) {
