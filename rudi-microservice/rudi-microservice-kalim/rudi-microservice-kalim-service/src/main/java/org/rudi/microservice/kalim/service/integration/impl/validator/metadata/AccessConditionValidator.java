...
public class AccessConditionValidator extends AbstractMetadataValidator<MetadataAccessCondition> {
	...
	public Set<IntegrationRequestErrorEntity> validate(MetadataAccessCondition metadataAccessCondition) {
		...
		if (metadataAccessCondition != null) {
			...
			IntegrationRequestErrorEntity integrationRequestError = new IntegrationRequestErrorEntity(UUID.randomUUID(),
					IntegrationError.ERR_202.getCode(), errorMessage, RudiMetadataField.ACCESS_CONDITION.getLocalName(),
					LocalDateTime.now());
