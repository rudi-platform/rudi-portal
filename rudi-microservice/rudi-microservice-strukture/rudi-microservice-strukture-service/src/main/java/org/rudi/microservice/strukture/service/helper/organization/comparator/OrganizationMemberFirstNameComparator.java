...
public class OrganizationMemberFirstNameComparator implements Comparator<OrganizationUserMember> {

	@Override
	public int compare(OrganizationUserMember one, OrganizationUserMember two) {
		return Strings.CI.compare(one.getFirstname(), two.getFirstname());
	}
}
