package org.rudi.microservice.kos.facade.config.swagger;
...
public class MicroServiceOpenApiSwaggerConfig extends OpenApiSwaggerConfig {
	...
	public GroupedOpenApi publicMgn() {
		return GroupedOpenApi.builder().group("kos").packagesToScan("org.rudi.microservice.kos.facade.controller")
				.build();
	}
