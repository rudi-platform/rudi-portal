...
//@Component
public class AuthorizationServerSecurityConfigurer
	...
	/**
	 * Custom authentication filters for the TokenEndpoint. Filters will be set upstream of the default BasicAuthenticationFilter.
	 */
	...
	/**
	 * Authentication provider(s) to use with the {@link AuthenticationManager}. Adding an authentication provider here will replace the default
	 * {@link DaoAuthenticationProvider}.
	 * 
	 * @param authenticationProvider the authentication provider to add
	 */
	public AuthorizationServerSecurityConfigurer addAuthenticationProvider(
	 ...
	 */
	public AuthorizationServerSecurityConfigurer authenticationEventPublisher(
...
// ensure this is initialized
	...
	private ClientCredentialsTokenEndpointFilter clientCredentialsTokenEndpointFilter(HttpSecurity http) {
		...
		OAuth2AuthenticationEntryPoint lauthenticationEntryPoint = new OAuth2AuthenticationEntryPoint();
		lauthenticationEntryPoint.setTypeName("Form");
		lauthenticationEntryPoint.setRealmName(realm);
		clientCredentialsTokenEndpointFilter.setAuthenticationEntryPoint(lauthenticationEntryPoint);
