...
@Component({
    ...
    imports: [SearchCountComponent, LoaderComponent, MatTable, MatSort,
        MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatSortHeader, MatCellDef, MatCell, MatIcon, NgClass, MatHeaderRowDef,
        MatHeaderRow, MatRowDef, MatRow, RouterLink, BackPaginationComponent,
        DatePipe, TranslatePipe, NgxPaginationModule, ReplaceIfNullPipe, SelfdataProcessDefinitionKeyTranslatePipe]
})
